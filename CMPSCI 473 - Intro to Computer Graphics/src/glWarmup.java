...
public class glWarmup extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener, MouseWheelListener,ActionListener{
	...
	// a set of shapes
	private static final int Triangle = 0, Torus = 1, Sphere = 2, Icosahedron = 3, Teapot = 4, Cube = 5, BigCone = 6, Dodecahedron = 7;
	...
	// constructor
	public glWarmup() {
		super("Intro Graphics Assignment 1");
		canvas = new GLCanvas();
	...
	public void drawShape() {
		...
		gl.glRotatef(angleZ, 0.0f, 0.0f, 90.0f);
